...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Install the codex main/subagent orchestrator scaffold into a repo."
    )
    parser.add_argument(
        "--workdir",
        default=".",
    ...
    parser.add_argument(
        ...
        help="Target folder name inside workdir (default: codex-orchestrator).",
    )
    parser.add_argument(
        "--force",
        action="store_true",
        help="Overwrite existing target folder if present.",
    )
    parser.add_argument(
        "--no-gitignore",
        action="store_true",
        help="Do not add .codex/loop/ to .gitignore.",
    )
    ...
    if not args.no_gitignore:
        _ensure_gitignore_line(workdir, ".codex/loop/")
